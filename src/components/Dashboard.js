...
const images =[hello, askingquestion, GreaterOrLess, magic8ball, oddEven, reverse, addingNumbers, madlibs, restaurant  ]
const paths = ["/Say-Hello", "/Asking-Questions", "/Greater-Less", "/Magic-8-Ball", "Odd-Even", "Reverse-It", "/Add-2-Numbers", "/MadLibs", "/Restaurant-Picker"]

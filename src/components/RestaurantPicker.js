...
function RestaurantPicker() {
  let [Title, setTitle] = useState("Today you will be eating at:");
    ...
    <>
      ...
      <div className="restaurant-bg pt-5">
        <Container>
          ...
          <Row>
            <Row>
              <Col className="d-flex justify-content-center pt-3">
                <h4>
                  Choose a type of restaurant below then press the A button
                </h4>
              </Col>
            </Row>
          ...
          <Row>
            <Col className="d-flex justify-content-center pt-1">Submit</Col>
          </Row>
        </Container>
      </div>
    </>
